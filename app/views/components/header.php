...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top shadow-sm p-2">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler mobile-sidebar-toggler" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#mobileSidebar" aria-controls="mobileSidebar">
                <span class="navbar-toggler-icon"></span>
            </button>

            <a class="navbar-brand d-flex align-items-center" href="/dashboard" style="margin-left: 10px;">
                <img src="assets/image/CTU_logo.png" alt="Logo" style="max-height: 40px; margin-right: 15px;">
    ...
    <nav class="sidebar d-none d-lg-block">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="/users" class="nav-link <?php echo ($currentRoute == '/users') ? 'active' : ''; ?>">
                    <i class="bi bi-people-fill"></i> Quản lý Users
                </a>
            </li>
            <li class="nav-item">
                <a href="/sinhvien" class="nav-link <?php echo ($currentRoute == '/sinhvien') ? 'active' : ''; ?>">
                    <i class="bi bi-person-badge"></i> Sinh Viên
                </a>
            </li>
            <li class="nav-item">
                <a href="/phong" class="nav-link <?php echo ($currentRoute == '/phong') ? 'active' : ''; ?>">
                    <i class="bi bi-door-open"></i> Phòng
                </a>
            </li>
            <li class="nav-item">
                <a href="/loaiphong" class="nav-link <?php echo ($currentRoute == '/loaiphong') ? 'active' : ''; ?>">
                    <i class="bi bi-stack"></i> Loại Phòng
                </a>
            </li>
            <li class="nav-item">
                <a href="/hopdong" class="nav-link <?php echo ($currentRoute == '/hopdong') ? 'active' : ''; ?>">
