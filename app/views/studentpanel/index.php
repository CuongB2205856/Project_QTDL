                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <h2 class="mb-2">
                            ...
                            Xin chào,
                            <strong><?php echo htmlspecialchars($data['details']['HoTen'] ?? $data['maSV']); ?></strong>
                        </h2>
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <?php if (!empty($data['details']['SoPhong'])): ?>
                            <h3 class="mb-0 text-primary fw-bold">
                                <?php echo htmlspecialchars($data['details']['SoPhong']); ?></h3>
                            <small
                                class="text-muted"><?php echo htmlspecialchars($data['details']['TenLoaiPhong']); ?></small>
                        <?php else: ?>
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <?php if (!empty($data['details']['GiaTienPhaiDong'])): ?>
                            <h3 class="mb-0 text-danger fw-bold">
                                <?php echo number_format($data['details']['GiaTienPhaiDong']); ?> ₫</h3>
                ...
                <?php if (!empty($data['details']['SoPhong'])): ?>
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            ...
                            <strong
                                class="text-primary"><?php echo htmlspecialchars($data['details']['SoPhong']); ?></strong>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span class="text-muted">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            ...
                            <strong class="text-success"><?php echo number_format($data['details']['GiaTienThuePhong']); ?>
                                ₫</strong>
                        </div>
                    </div>
                <?php else: ?>
                ...
                <?php if (!empty($data['details']['GiaTienPhaiDong'])): ?>
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            ...
                            <strong
                                class="text-danger fs-5"><?php echo number_format($data['details']['GiaTienPhaiDong']); ?>
                                ₫</strong>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <span class="text-muted">
                            ...
                            <strong
                                class="text-danger"><?php echo date("d/m/Y", strtotime($data['details']['NgayDenHanDongTien'])); ?></strong>
                        </div>
                    </div>
                    <div class="mt-3">
            ...
            <div class="modal-body p-4">
                <form id="change-pass-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="confirm_new_pass" name="confirm_new_pass" class="form-control"
